...
<form
  ...
  <div class="input-group">
    <input type="number" class="form-control bg-light border-0 small" name="id" placeholder="Time ID"
...
<form
  ...
  @csrf
  <div class="input-group">
    <input type="text" class="form-control bg-light border-0 small" name="name" placeholder="Time Name"
      aria-label="Search" aria-describedby="basic-addon2">
    <div class="input-group-append">
      <button class="btn btn-primary" type="submit">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="main-search">
...
<div class="card shadow">
  <div class="card-header py-3">
    <h4 class="m-0 font-weight-bold text-primary">Times</h>
  </div>
  <div class="card-body">
    <table class="table table-sm mt-2 text-center table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="{{route('time.show',$row->timeID)}}" class="btn  btn-info btn-sm">
              Details
            </a>
          </td>
        </tr>
